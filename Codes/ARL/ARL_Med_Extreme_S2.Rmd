---
title: "Extereme Spread (Second spread)"
author: "Hadi"
date: "2023-12-05"
...
write.csv(Cal2022tr_ext_S2, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2020tr_ext_S2.csv", quote = FALSE, row.names = FALSE)

#2021
Cal2021tr_ext_S2 <- ARL_2021_ext_S2 %>%
  unite(item, everything(), sep = ",")

write.csv(Cal2021tr_ext_S2, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2021tr_ext_S2.csv", quote = FALSE, row.names = FALSE)
...
write.csv(Cal2022tr_ext_S2, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2022tr_ext_S2.csv", quote = FALSE, row.names = FALSE)

#2023
Cal2023tr_ext_S2 <- ARL_2023_ext_S2 %>%
  unite(item, everything(), sep = ",")

write.csv(Cal2023tr_ext_S2, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2023tr_ext_S2.csv", quote = FALSE, row.names = FALSE)
...
write.csv(Cal_t_tr_ext_S2, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal_t_tr_ext_S2.csv", quote = FALSE, row.names = FALSE)
...
tr2020__ext_S2 <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2020tr_ext_S2.csv", format = "basket", sep = ",")


tr2021_ext_S2 <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2021tr_ext_S2.csv", format = "basket", sep = ",")

tr2022_ext_S2 <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2022tr_ext_S2.csv", format = "basket", sep = ",")


tr2023_ext_S2 <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2023tr_ext_S2.csv", format = "basket", sep = ",")

tr_ext_S2 <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal_t_tr_ext_S2.csv", format = "basket", sep = ",")
