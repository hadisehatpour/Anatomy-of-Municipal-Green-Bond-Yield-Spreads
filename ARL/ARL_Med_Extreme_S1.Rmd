---
title: "Extereme Spread (First spread)"
author: "Hadi"
date: "2023-12-05"
...
write.csv(Cal2022tr_int, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2020tr_int.csv", quote = FALSE, row.names = FALSE)

#2021
Cal2021tr_int <- ARL_2021 %>%
  unite(item, everything(), sep = ",")

write.csv(Cal2021tr_int, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2021tr_int.csv", quote = FALSE, row.names = FALSE)
...
write.csv(Cal2022tr_int, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2022tr_int.csv", quote = FALSE, row.names = FALSE)

#2023
Cal2023tr_int <- ARL_2023 %>%
  unite(item, everything(), sep = ",")

write.csv(Cal2023tr_int, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2023tr_int.csv", quote = FALSE, row.names = FALSE)
...
write.csv(Cal_t_tr_int, "C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal_t_tr_int.csv", quote = FALSE, row.names = FALSE)
...
tr2020_int <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2020tr_int.csv", format = "basket", sep = ",")


tr2021_int <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2021tr_int.csv", format = "basket", sep = ",")

tr2022_int <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2022tr_int.csv", format = "basket", sep = ",")


tr2023_int <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal2023tr_int.csv", format = "basket", sep = ",")

tr_int <- read.transactions("C:/Users/Hadi/Desktop/PhD/Thesis/First Project/Codes/Machine Learning ARL/Data/Cal_t_tr_int.csv", format = "basket", sep = ",")
